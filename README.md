...
Furthermore, it also doubles as an **active learning project** — every architectural decision is documented as an ADR, and each sub-feature is reinforced with DDIA-anchored concept quizzes to build durable systems design intuition. 
